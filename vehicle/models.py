...
class Request(models.Model):
    ...
    mechanic2=models.ForeignKey('Mechanic2',on_delete=models.CASCADE,null=True)
    which=(('waterauthority','waterauthority'),('kseb','kseb'))
    whiches= models.CharField(max_length=50,choices=which,null=True)
